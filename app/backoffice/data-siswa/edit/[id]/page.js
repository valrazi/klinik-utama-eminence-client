...
export default function DataGuruEditPage() {
    ...
    const fetchDetail = async () => {
        try {
            let data = await axios.get(`${API_URL}/student/` + id)
            data = data.data.data
            if (data) {
            ...
            alert('Fetch student data failed')
        }
    }
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoading(true)
            await axios.put(`${API_URL}/student/` + id, formData)
    ...
    return (
        <Container title={'Edit Data Siswa'}>
                        ...
                        <HStack gapX={'2rem'}>
                            <VStack width={'1/2'} justify={'start'} align={'start'}>
                                ...
                                <FormControl isInvalid={errors.ijazah_smp} style={{ width: '100%' }}>
                                    ...
                                    />
                                    {imagePreview && (
                                        <Link href={imagePreview} target="_blank" style={{
                                            fontSize: '12px',
                                            color: 'blue',
