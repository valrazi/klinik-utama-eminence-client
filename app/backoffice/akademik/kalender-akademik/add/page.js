...
export default function DataGuruAddPage() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoading(true)
            await axios.post(`${API_URL}/academic-calendar`, formData)
    ...
    return (
        <Container title={'Kalender Akademik'}>
            ...
            <Flex px={'5'} direction={'column'}>
                <Heading width={'fit'} fontWeight={'bold'} borderBottom={'4px solid yellow'} marginBottom={'30px'}>Kalender Akademik</Heading>
                    ...
                    <VStack spacing={4} align="stretch">
                        <HStack gapX={'2rem'}>
                            ...
                            <FormControl isInvalid={errors.foto} p={'4em'} style={{ borderRadius: '1rem' }} border={'1px solid black'}>
                                ...
                                <FormLabel>Foto Kalender Akdemik</FormLabel>
                                <Input
                                    type="file"
                                    accept="image/*"
                                    {...register('foto', {
