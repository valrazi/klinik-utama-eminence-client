...
export default function DataGuruEditPage() {
    ...
    const fetchDetail = async () => {
        try {
            let data = await axios.get(`${API_URL}/student-existing/` + id)
            data = data.data.data
            if (data) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoading(true)
            await axios.put(`${API_URL}/student-existing/` + id, {
                ...data
            })
    ...
    const deleteUser = async () => {
        try {
            ...
            if (isConfirmed) {
                ...
                router.push('/backoffice/administrasi/keterangan-siswa')
            }
        } catch (error) {
    ...
    return (
        <Container title={'Keterangan Siswa'}>
