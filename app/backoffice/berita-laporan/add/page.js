...
export default function DataGuruAddPage() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setLoading(true)
            await axios.post(`${API_URL}/news-report`, formData)
    ...
    return (
        <Container title={'Tambah Berita'}>
            ...
            <Flex px={'5'} direction={'column'}>
                <Heading fontWeight={'bold'} borderBottom={'4px solid yellow'} marginBottom={'30px'}>Data Berita</Heading>
